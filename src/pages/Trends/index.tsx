import {
  ...
  IonHeader, IonIcon,
  IonPage, IonRefresher, IonRefresherContent, IonRouterOutlet, IonSearchbar,
  IonTitle,
  IonToolbar
} from '@ionic/react';
import './index.css';
...
class Trends extends React.Component<TrendsProps, TrendsState> {
          ...
          topMoments: [
            {
              ...
              userTitle: "社团社长",
              authed: true,
              content: "这家合作是真的不行，从来没有见过这么不负责任的处理方式，取关了",
              upCount: 100,
              upRank: 1,
            },
            {
              ...
              username: "张威融",
              userTitle: "社团社长",
              content: "这家合作是真的行，合同签订快，资金汇款即使，双方非常愉快，期待再次合作",
              upCount: 30,
              upRank: 2,
            },
            {
  ...
  render() {
    ...
    if (this.state.loadingFirstTime) {
      ...
      topItemList = this.state.topMoments
        .map(info => <TopMomentItem info={info}/>)
      ...
      cardList = this.state.moments
        .filter(info => this.state.searchText == "" || info.content.includes(this.state.searchText))
    ...
    return (
      <IonPage>
        ...
        <IonContent fullscreen>
          ...
          <IonFab vertical="bottom" horizontal="center" style={{ bottom: 16 }} slot="fixed">
